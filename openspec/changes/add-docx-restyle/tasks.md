...
- [ ] 2.3 `include: ["page", "headers"]`: page size and margins per section (orientation kept, `w:sectPrChange`); header and footer parts replaced and repointed.
- [ ] 2.4 Text-unchanged check before writing; refusal on pending revisions.
...
## 4. Prove it
- [ ] 4.1 Fixture: a drifted document (English ids, hand-set fonts in body, table, header, footnote, comment; a custom style; a numbered list; a landscape section and its own header; a pending-revision variant).
