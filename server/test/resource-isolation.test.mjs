/**
 * Test: noExtensions + extensionPaths + noSkills + skillPaths + noPromptTemplates + promptPaths
 * isolation.
 *
...
describe("resource isolation", () => {
  ...
  test("noExtensions + extensionPaths + noSkills + skillPaths + noPromptTemplates + promptPaths together", async () => {
