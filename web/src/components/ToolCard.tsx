  ...
  return (
    <div
      className={`rounded-lg border text-sm ${
        item.isError ? "border-red-900/60 bg-red-950/20" : "border-zinc-800 bg-zinc-900/60"
      }`}
    >
      <button
        type="button"
      ...
      >
        ...
        <span className="font-mono font-medium text-zinc-300">{item.toolName}</span>
        {summary && (
      ...
      {open && (
        <div className="border-t border-zinc-800 px-3 py-2">
          {summary === "" || (
            <pre className="mb-2 overflow-x-auto font-mono text-xs text-zinc-400">
